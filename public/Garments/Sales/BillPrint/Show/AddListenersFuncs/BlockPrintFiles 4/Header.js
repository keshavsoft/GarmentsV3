...
const jFLocalMaguvaHeader = ({ inHtmlPrintDiv }) => {
    inHtmlPrintDiv.innerHTML += `               <span class="inner-pre" style="font-size: 33px; font-weight: ; font-family: Grobek Normal">MAGUVA</span>\n`;
    inHtmlPrintDiv.innerHTML += `     <span class="inner-pre" style="font-size: 16px;">50-50-30/12/2, vandana plaza,</span>\n`;
    inHtmlPrintDiv.innerHTML += `        <span class="inner-pre" style="font-size: 16px;">GURUDWARA,VISHAKAPATNAM,</span>\n`;
    inHtmlPrintDiv.innerHTML += `<span class="inner-pre" style="font-size: 16px;">GSTIN:37ACJPL9300K2ZB,Ph:08912796666,</span>\n`;
    inHtmlPrintDiv.innerHTML += `                <span class="inner-pre" style="font-size: 16px;">State Code:37</span>\n`;
};
